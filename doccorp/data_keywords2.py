...
class DataKeywords:
    ...
    def data(cls, issue, login='none', password='none', config_path='none'):
        ...
        fucking_list = ['timespent', 'customfield_17501', 'project', 'customfield_15200', 'customfield_17500', 'fixVersions', 'customfield_15201', 'resolution', 'customfield_11400',
                        ...
                        'assignee', 'status', 'customfield_14810', 'customfield_15700', 'customfield_17800', 'attachment', 'creator', 'reporter', 'customfield_11405',
                        'votes', 'worklog', 'customfield_11404', 'comment', 'customfield_10056'
                        ]
        ...
        with open('k.json', 'w', encoding='utf-8') as file:
            json.dump(issue, file, ensure_ascii=False, indent=2)
